    ...
    <>
      <section className="relative overflow-hidden min-h-screen flex flex-col">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div
            className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[700px] h-[400px] rounded-full animate-breathe"
            style={{ background: "radial-gradient(ellipse, rgba(231,138,83,0.06) 0%, transparent 70%)" }}
          />
          <div
        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <Badge variant="secondary" className="inline-flex items-center gap-2 px-4 py-2 text-sm shadow-[0_0_15px_rgba(231,138,83,0.15)] border-[#e78a53]/20">
                <Sparkles className="h-4 w-4 text-[#e78a53]" />
                PIXECELATE | Built to close
              </Badge>
            </motion.div>
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                PIXECELATE builds web experiences that <strong>convert buyers</strong> and make <strong>teams legendary</strong>
              </h1>
            </motion.div>
            ...
            >
              We design, write, and ship premium sites for businesses and individuals who refuse average. Every page is conversion-first, performance-tuned, and ready to launch without the usual drama.
            </motion.p>
            ...
            >
              ...
              <div className="flex items-center justify-center">
                <a href="#features">
                  <div className="group cursor-pointer border border-border bg-card gap-2 h-[60px] flex items-center p-[10px] rounded-full relative overflow-hidden transition-shadow duration-300 hover:shadow-[0_0_25px_rgba(231,138,83,0.2)]">
                    {/* Shimmer sweep */}
                    <div
                    ...
                    <div className="border border-border bg-primary h-[40px] rounded-full flex items-center justify-center text-primary-foreground">
                        ...
                        Skyrocket your JOURNEY with PIXECELATE
                      </p>
                    </div>
          ...
          >
              ...
              <p className="text-sm text-muted-foreground mb-6">Built with modern, reliable web technologies for production</p>
              <div className="flex items-center justify-center gap-8 px-8 py-4 rounded-full border border-white/5 bg-white/[0.02] backdrop-blur-sm">
                {/* Vercel Logo */}
