...
export function NewReleasePromo() {
  return (
    <section className="mt-12 w-full">
      <div className="mx-auto max-w-4xl rounded-[40px] border border-black/5 dark:border-white/20 p-2 shadow-sm hover:shadow-[0_0_40px_rgba(231,138,83,0.1)] transition-shadow duration-700">
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-black/5 dark:border-white/20 bg-primary p-2 shadow-sm">
          ...
          {/* Corner glow accents */}
          <div className="absolute top-0 left-0 w-32 h-32 rounded-full bg-white/5 blur-2xl pointer-events-none" />
          <div className="absolute bottom-0 right-0 w-40 h-40 rounded-full bg-black/20 blur-3xl pointer-events-none" />
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Websites & support for businesses and individuals</h2>
              <p className="text-white/60 mb-8">We design, build, and support websites for agencies, businesses, and creators.</p>
              <svg
                width="100"
                height="50"
                viewBox="0 0 100 50"
              ...
              <div className="flex items-center justify-center">
                <a href="#features">
                  <div className="group border-border bg-secondary/70 flex h-[64px] cursor-pointer items-center gap-2 rounded-full border p-[11px] mt-10 relative overflow-hidden transition-shadow duration-300 hover:shadow-[0_0_20px_rgba(0,0,0,0.3)]">
                    {/* Shimmer sweep */}
                    <div
                    ...
                    <div className="border-border bg-primary flex h-[43px] items-center justify-center rounded-full border">
                        ...
                        Book your build with PIXECELATE
                      </p>
                    </div>
