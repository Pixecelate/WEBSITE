...
export const FollowerPointerCard = ({
  ...
  useEffect(() => {
    console.log("[PIXECELATE] FollowerPointerCard mounted")
    return () => {
      console.log("[PIXECELATE] FollowerPointerCard unmounted")
    }
  }, [])

  useEffect(() => {
    console.log("[PIXECELATE] isInside changed:", isInside)
  }, [isInside])
