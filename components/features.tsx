...
export default function Features() {
  ...
  return (
    <section id="features" className="text-foreground relative overflow-hidden py-12 sm:py-24 md:py-32">
      ...
      {/* Extra ambient floating glow */}
      <div className="absolute top-[40%] right-0 w-64 h-64 rounded-full pointer-events-none animate-float-drift-reverse" style={{ background: "radial-gradient(circle, rgba(231,138,83,0.04) 0%, transparent 70%)" }} />
      <div className="absolute bottom-[20%] left-0 w-48 h-48 rounded-full pointer-events-none animate-float-drift" style={{ background: "radial-gradient(circle, rgba(255,255,255,0.02) 0%, transparent 70%)" }} />
      <motion.div
        ref={ref}
      ...
      >
        <h2
          className={cn(
            "via-foreground mb-8 bg-gradient-to-b from-zinc-400 via-white to-zinc-400 bg-clip-text text-center text-4xl font-semibold tracking-tighter text-transparent md:text-[54px] md:leading-[60px]",
            geist.className,
          )}
        >
          Features that make buyers say yes
        </h2>
        <FollowerPointerCard
          title={
            <div className="flex items-center gap-2">
              <span>✨</span>
              <span>Precision-built advantages</span>
            </div>
          }
        >
            ...
            <div className="grid grid-cols-12 gap-4 justify-center">
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Command & Concierge</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px] mb-2">
                      Connect with PIXECELATE. We handle the busy work when you need speed and give hands-on help when you need confidence. We stay with your team until it is done.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="flex items-center gap-8">
                        ...
                        <div className="flex flex-col gap-3">
                          {["Deal-ready content", "Conversion assets", "Enterprise polish"].map((item, index) => (
                            <motion.div
                              key={`left-${index}`}
                        ...
                        {/* Right Column */}
                        <div className="flex flex-col gap-3">
                          {["Live launch support", "Trusted payments", "Executive-ready QA"].map((item, index) => (
                            <motion.div
                              key={`right-${index}`}
                              className="bg-white rounded px-3 py-2 flex items-center gap-2 text-black text-sm font-medium shadow-sm"
                              initial={{ opacity: 1, x: 0 }}
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Global, Fast, Unbreakable</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      We launch PIXECELATE sites on the tools you already use, like Next.js or static builds. Every visitor gets a quick load, a stable site, and an easy path to buy.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Smart experiences that sell</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Pages come ready with simple cues and small motions that keep people moving through your story and toward the button that matters.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Dynamic layouts that do the selling</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Flexible layouts that shift to fit any screen and keep your main message up front, whether someone is on a big monitor or an older phone.
                    </p>
                  </div>
                </div>
                <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">
