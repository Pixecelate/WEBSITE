...
const pricingPlans = [
  {
    name: "Starter",
    price: "Free",
    description: "For personal brands and fast, single-page launches",
    features: ["Launch-ready landing page", "Brand styling applied", "Copy pass + QA", "Email support"],
    popular: false,
    cta: "Get Started",
  },
  {
    ...
    monthlyPrice: 29,
    annualPrice: 24,
    description: "For businesses ready for a full website build",
    features: [
      "Multi-page website delivered",
  ...
  },
  {
    ...
    monthlyPrice: 99,
    annualPrice: 79,
    description: "For teams that need continuous improvements",
    features: [
      "Everything in Pro",
      "Stakeholder workshops",
      "Ongoing CRO & A/B testing",
      "Integrations with your stack",
      "Content + campaign rollouts",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-white/60 max-w-2xl mx-auto mb-8">
            Start shipping conversion-ready sites with a team that treats your brand like their own.
          </p>
